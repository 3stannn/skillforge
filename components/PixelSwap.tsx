...
import React, { useCallback, useEffect, useMemo, useRef, useState, ReactNode, CSSProperties } from 'react';
...
const buildGrid = ({ width, height, pixelSize, gap, pattern, randomness }: GridOptions): GridResult => {
  let size = pixelSize;
...
export function PixelSwap({
  ...
  return (
    <div
      ...
      style={{ ...(aspectRatio && aspectRatio !== 'none' ? { aspectRatio } : {}), ...style }}

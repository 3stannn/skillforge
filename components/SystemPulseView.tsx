...
export function SystemPulseView({ currentDesign, onSelectSystem }: SystemPulseViewProps) {
  return (
    <div className="space-y-6 text-left">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-3.5">
        <div className="p-4 bg-[#090b0e] border border-[#1e2229] rounded-xl space-y-1">
          ...
          <div className="text-[10px] text-[#34d399] font-mono">⚡ 4.2x faster than manual</div>
        </div>
      ...
      <div className="p-5 bg-[#090b0e] border border-[#1e2229] rounded-2xl space-y-4 shadow-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Activity className="w-4 h-4 text-[#3186ff]" />
            <span className="text-xs font-semibold text-white uppercase tracking-wider font-mono">
              Live Extraction Stream
            </span>
          </div>
          <span className="text-[10px] font-mono text-[#585a5c]">Live Benchmarks</span>
        </div>
        ...
        <div className="space-y-3 font-mono text-xs">
          <div className="p-3 bg-[#0e1116] border border-[#1e2229] rounded-xl flex items-center justify-between">
            ...
            <button
              ...
              className="text-[#3186ff] hover:text-[#70a7ff] text-[11px] flex items-center gap-1 cursor-pointer font-sans"
            >
